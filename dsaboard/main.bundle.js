            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        height = 0;
                        width = 0;
                        return [4 /*yield*/, Promise.all(Object.values(this.structList).map(function (struct) { return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, struct.preDraw(ctx)];
                                        case 1:
                                            _a.sent();
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, Promise.all(Object.values(this.structList).map(function (struct) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, struct.draw(ctx)];
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "dsaboard:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkdsaboard"] = self["webpackChunkdsaboard"] || [];
...
// EXTERNAL MODULE: ./src/components/Header/assets/GitHub-Mark-Light-64px.png
var GitHub_Mark_Light_64px = __webpack_require__(20);
;// CONCATENATED MODULE: ./src/components/Header/index.tsx


var Header = function () {
    return (react.createElement("header", { className: "flex justify-between items-center p-2 select-none" },
        react.createElement("h1", { className: "text-2xl text-white" }, "DSA Board"),
        react.createElement("a", { href: "https://github.com/Chetan-Satpute/DSABoard", target: "_blank" },
            react.createElement("img", { src: GitHub_Mark_Light_64px, height: 32, width: 32 }))));
};
/* harmony default export */ const components_Header = (Header);

;// CONCATENATED MODULE: ./src/utils/resetCanvasView.ts
var resetCanvasView = function () {
...
var Canvas = function () {
    var canvasContainer = (0,react.useRef)();
    (0,react.useEffect)(function () {
        canvasContainer.current.appendChild(Board/* default.canvas */.Z.canvas);
        return function () {
            canvasContainer.current.removeChild(Board/* default.canvas */.Z.canvas);
        };
    }, []);
    return (react.createElement("div", { ref: canvasContainer, id: "canvas-container", className: "h-full overflow-auto" }));
};
...
var Main = function () {
    var _a = (0,react.useState)(false), fullscreen = _a[0], setFullscreen = _a[1];
    var toggleFullScreen = function (value) { return __awaiter(void 0, void 0, void 0, function () {
        var root, error_1, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    root = document.getElementById("root");
                    if (!(document.fullscreenElement && value !== true)) return [3 /*break*/, 5];
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                ...
                case 5:
                    _a.trys.push([5, 7, , 8]);
                    return [4 /*yield*/, root.requestFullscreen({ navigationUI: "hide" })];
                case 6:
                    _a.sent();
                    setFullscreen(true);
                    return [3 /*break*/, 8];
...
function useResponsiveScreen() {
    var _a = (0,react.useState)(0), width = _a[0], setWidth = _a[1];
    (0,react.useEffect)(function () {
...
var Panel = function () {
    ...
    var play = function (func) { return Panel_awaiter(void 0, void 0, void 0, function () {
        return Panel_generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    showLoading(true);
...
var App = function () {
    return (react.createElement("div", { className: "h-screen w-screen flex" },
        react.createElement("div", { className: "w-full flex flex-col p-1 lg:w-2/3" },
            react.createElement(components_Header, null),
            react.createElement(components_Main, null)),
        react.createElement(components_Panel, null)));
};
